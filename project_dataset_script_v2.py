...
voc_root_folder = "../data/"  # please replace with the location on your laptop where you unpacked
# the tarball
image_size = 128    # image size that you will use for your network (input images will be resampled
# to this size), lower if you have troubles on your laptop (hint: use io.imshow to inspect the quality of the resampled images before feeding it into your network!)
